...
<input class="form-control" type="input" name="A_Name" size="50" value="<?php echo $answers_item['A_Name'] ?>" readonly/>
</div>
</br>
</br>
<div class="form-group">
<label for="A_Correct">Correct/Not</label>
<input class="form-control" type="input" name="A_Correct" size="50" value="<?php echo $answers_item['A_Correct'] ?>" readonly/>
</div>
</form>
    </div>
  </div>
