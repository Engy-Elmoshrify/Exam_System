...
<?php echo form_open('answer/edit/'.$answers_item['A_Id']); ?>
    <table>
        <tr>
            ...
            <td><input class="form-control" type="input" name="A_Name" size="50" value="<?php echo $answers_item['A_Name'] ?>" /></td>
        </tr>

        <tr>
            <td><label for="A_Correct">Correct/Not</label></td>
            <td><select class="form-control"  id = "A_Correct" name="A_Correct">
            <?php if($answers_item['A_Correct'] == 'true'){?>
                    <option value="true" selected > true </option>
                    <?php }
                   if($answers_item['A_Correct'] == 'false'){?>
                    <option value="false" selected > false </option>
                    <?php }
                    if($answers_item['A_Correct'] != 'true'){?>
        ...
        <tr>
            <td><input class="btn btn-success" type="submit" name="submit" value="Edit Answer" /></td>
        </tr>
    </table>
</form>
