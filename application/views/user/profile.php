  ...
  <div class="row h_menu">
    ...
    <div class="soc_icons navbar-right">
      <ul class="list-unstyled text-center">
        <li ><a href="<?php echo site_url('User/profile'); ?>"><i class="fa fa-user" aria-hidden="true"></i></a></li>
...
<input class="form-control" type="input" name="User_Name" size="50" value="<?php echo $userInfo['User_Name'] ?>" readonly/>
</div>
</br>
</br>
<div class="form-group">
<label for="User_Mail">Email-Address</label>
<input class="form-control" type="input" name="User_Mail" size="50" value="<?php echo $userInfo['User_Mail'] ?>" readonly/>
</div>
</form>
