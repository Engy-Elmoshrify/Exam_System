...
<?php echo form_open('user/edit/'.$users_item['User_Id'],array('class' => 'form-inline')); ?>
    <table>
        <tr>
            ...
            <td><input class="form-control" type="input" name="User_Name" size="50" value="<?php echo $users_item['User_Name'] ?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td><input class="btn btn-success"  type="submit" name="submit" value="Edit User" /></td>
        </tr>
    </table>
</form> 
