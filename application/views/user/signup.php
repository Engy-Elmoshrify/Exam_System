    ...
    <table>
       <div class="form-group">
        <tr>
            ...
            <td><input class="form-control" type="input" name="User_Name" size="50" /></td>
        </tr>
        </div>
        <div class="form-group">
       <tr>
            <td><label for="User_Mail">Mail</label></td>
            <td><input class="form-control" type="input" name="User_Mail" size="50" /></td>
        </tr>
        </div>
        <div class="form-group">
        <tr>
            <td><label for="User_Password">Password</label></td>
            <td><input class="form-control" type="input" name="User_Password" size="50" /></td>
        </tr>
        </div>
        <div class="form-group">
        <tr>
            <td></td>
            <td><input class="btn btn-success" type="submit" name="submit" value="Create User" /></td>
        </tr>
        </div>
    </table>    
</form>
