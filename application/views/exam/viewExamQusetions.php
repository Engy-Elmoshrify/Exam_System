...
<div class="container">
  <div class="row header">
<center><h2><?php echo $question_item['Q_Name'];?></h2></center>
...
<center>
     <ul class="pagination">
                ...
                for ($x = 1; $x <= $q_count['counter']; $x++) {
                    echo '<li><a href="'.site_url('exam/getQuestionofExam/'.$exams_item['Exam_Id'].'/'.$x.'/'.$question_item['Q_Id']).'">'.$x.'</a></li>';
                }
